...
def train(train_path: str, test_path: str, model_save_dir: str):
    ...
    for ml_name, model in models.items():
        ...
        with mlflow.start_run(run_name=f"{ml_name}"):
            ...
            mlflow.log_metric("auc_train", auc_train) # type: ignore
            mlflow.log_metric("auc_test", auc_test) # type: ignore
            mlflow.log_metric("decay_percent", decay) # type: ignore
            ...
            current_run_id = current_run.info.run_id # type: ignore
            current_artifact_uri = current_run.info.artifact_uri # type: ignore
